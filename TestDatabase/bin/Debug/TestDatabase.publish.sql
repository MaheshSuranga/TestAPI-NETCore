...
GO
PRINT N'Creating [dbo].[CheckEmail]...';
...
AS
	...
	SELECT '0'
GO
PRINT N'Creating [dbo].[CheckUserCode]...';
...
AS
	...
	SELECT '0'
GO
PRINT N'Creating [dbo].[InsertUserCredentials]...';
...
END
GO
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '5eb0772c-3b25-44e2-aaa6-1fe86335118a')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('5eb0772c-3b25-44e2-aaa6-1fe86335118a')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'cc5a27ca-b257-4b11-b9b3-1b6ba315a563')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('cc5a27ca-b257-4b11-b9b3-1b6ba315a563')
